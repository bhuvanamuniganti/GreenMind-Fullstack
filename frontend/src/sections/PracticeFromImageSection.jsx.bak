...
export default function PracticeFromImageSection() {
  ...
  async function analyze() {
    ...
    try {
      ...
      const res = await fetch("http://localhost:4000/api/practice-image/analyze", {
        method: "POST",
        body: form,
        headers,
        credentials: "include",
  ...
  async function transcribeOne(qid) {
    ...
    const r = await fetch("http://localhost:4000/api/practice-image/transcribe", {
      method: "POST",
      body: form,
      credentials: "include",
    });
  ...
  async function gradeWrittenAll() {
    ...
    const r = await fetch("http://localhost:4000/api/practice-image/grade", {
      method: "POST",
  ...
  async function gradeOralOne(q) {
    ...
    const r = await fetch("http://localhost:4000/api/practice/oral-grade", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      credentials: "include",
  ...
  async function generateSimilar() {
    ...
    setLoading(true);
    try {
      const r = await fetch("http://localhost:4000/api/practice-image/similar", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
        body: JSON.stringify({
